...
import { Palette, Users, Layers, Shield } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <nav className="relative z-50 container mx-auto px-6 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="#features"
              className="text-gray-300 hover:text-violet-400 transition-all duration-300 font-medium"
            >
              Features
            </a>
            <Button
      ...
      <section className="relative z-10 container mx-auto px-6 py-24">
        <div className="text-center max-w-6xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-16 max-w-4xl mx-auto leading-relaxed font-light">
            The ultimate collaborative drawing platform that transforms your
            teams creativity.
            <br className="hidden md:block" />
            Experience real-time collaboration, powerful tools, and seamless
            sharing in one beautiful interface.
          </p>
            ...
            <div className="bg-gray-900 rounded-2xl p-12 min-h-[500px] flex items-center justify-center border border-gray-700">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-lg">
                  Interactive drawing canvas will appear here
                </p>
      ...
      <section
        id="features"
        className="relative z-10 py-32 bg-gradient-to-b from-transparent to-gray-900/30"
      >
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Powerful features designed for modern creative teams who value
              collaboration, efficiency, and beautiful design.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card hover variant="elevated">
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                ...
                as everyone contributes to the same canvas.
              </p>
            </Card>
            ...
            <Card hover variant="elevated">
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                Organize your work with unlimited layers, blend modes, and
            ...
            <Card hover variant="elevated">
              ...
              <p className="text-gray-300 leading-relaxed text-lg">
                Your work is protected with enterprise-grade security and
        ...
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed">
              Join thousands of teams already using CollabDraw to create amazing
              things together. Start your creative journey today.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            ...
            <div className="flex space-x-8 text-gray-400">
              <a
                href="#"
                className="hover:text-violet-400 transition-colors duration-300 font-medium"
              >
                Privacy
              </a>
              <a
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-500">
            <p>
              &copy; 2025 CollabDraw. All rights reserved. Made with ❤️ for
